---
id: keyexchange
title: "Post-Quantum Key Exchange (KEM) - QubeSec"
description: "Implement quantum-safe key exchange with Kyber (ML-KEM-1024). Complete guide to encapsulation, decapsulation, and key derivation in Kubernetes."
keywords:
  - key exchange
  - kyber
  - ML-KEM
